...
class DefaultFormatter {
  ...
  /**
   * Facotry method for creating new instances of DefaultFormatter.
   *
  ...
  static create(options) {
    ...
    const stringify = assertStringify(opts.mode);
    const fields = {
    ...
    return new DefaultFormatter(stringify, fields);
  }
  ...
  clone(data) {
    ...
    const cloned = new DefaultFormatter(this._stringify, this._fields);
    const supplement = Object.assign(this._supplement, data);
    cloned.supplement(supplement);
   ...
   *
   * @param {object} data - The supplemental log data
   */
  supplement(data) {
  }
